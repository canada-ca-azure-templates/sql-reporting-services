...
function Set-TargetResource
{
    ...
    if ( $null -ne $reportingServicesData.Configuration )
    {
        ...
        if ( -not $reportingServicesData.Configuration.IsInitialized )
        {
            ...
            New-VerboseMessage -Message "GenerateDatabaseCreationScript"
            $invokeRsCimMethodParameters = @{
                CimInstance = $reportingServicesData.Configuration
            ...
            $reportingServicesServiceAccountUserName = (Get-CimInstance -ClassName Win32_Service | Where-Object -FilterScript {
              ...
              #  New-VerboseMessage -Message $reportingServicesDatabaseScript
                #isremote was false - UserName = $reportingServicesServiceAccountUserName
            $invokeRsCimMethodParameters = @{
                CimInstance = $reportingServicesData.Configuration
            ...
            New-VerboseMessage -Message $reportingServicesDatabaseRightsScript
            <#
            ...
            #>
            New-VerboseMessage -Message "Invoking SQL commands for database and rights"
            Import-SQLPSModule
            Invoke-Sqlcmd -ServerInstance $reportingServicesConnection -Query $reportingServicesDatabaseScript.Script #-Username $SQLAdminCredential.Username -Password  $SQLAdminCredential.GetNetworkCredential().Password
            Invoke-Sqlcmd -ServerInstance $reportingServicesConnection -Query $reportingServicesDatabaseRightsScript.Script #-Username $SQLAdminCredential.Username -Password  $SQLAdminCredential.GetNetworkCredential().Password
            
            New-VerboseMessage -Message "Setting database connection"
            $invokeRsCimMethodParameters = @{
                CimInstance = $reportingServicesData.Configuration
            ...
            New-VerboseMessage -Message "Initalize reporting server"
            $invokeRsCimMethodParameters = @{
                CimInstance = $reportingServicesData.Configuration
            ...
            New-VerboseMessage -Message "restarting service"
...
function Test-TargetResource
{
    ...
    $test = Compare-Object @compareParameters
    New-VerboseMessage -Message "compare server reserved urls:$test"
    if ( ($null -ne $ReportServerReservedUrl) -and ($null -ne (Compare-Object @compareParameters)) )
    {
    ...
    $test = Compare-Object @compareParameters
    New-VerboseMessage -Message "compare  reserved urls:$test"
    if ( ($null -ne $ReportsReservedUrl) -and ($null -ne (Compare-Object @compareParameters)) )
    {
...
#Modified by JN for now.  Matches older xSQLServerRSConfig
